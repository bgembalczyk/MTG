...
class TestGame(TestGameBase):
    ...
    def test_mana_emptying(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "+ self.mana.pool[mana.Mana.RED] == 0",
                "",  # p 0
                "__self.tmp = self.mana.pool[mana.Mana.BLUE] == 0",
                "",  # p 1
                "s draw",
                "s draw",
            ],
    ...
    def test_attacking(self):
        with mock.patch(
            ...
            self.assertTrue(self.player.tmp)
            self.assertTrue(
                self.player.battlefield.get_card_by_name("Devouring Deep").status.tapped
            )
            self.assertFalse(
                self.player.battlefield.get_card_by_name("Devouring Deep").in_combat
            )
    ...
    def test_multiple_attacker(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "0 1 2",
                "",
                "",  # attacking w/ everything
                "",
                "0",
                "",  # blocking the second drake
                "s precombat_main",
                "s precombat_main",
                "",
            ],
    ...
    def test_triplicate_spirits(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "s main",
                "s main",
                "__self.mana.add(mana.Mana.WHITE, 10)",
                ...
                "",  # it resolves
                "s upkeep",
                "s upkeep",  # player 0's turn again
            ],
        ):
            self.player.autoPayMana = False
            self.GAME.handle_turn()
    ...
    def test_target_fizzling(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "p Ulcerate",
                "ob 0",  # should fizzle and thus not lose life
                "p Peel from Reality",
                "b 0",
                "ob 0",  # should still resolve with one target illegal
                "p Peel from Reality",
                "b 1",
                "ob 0",
                "s upkeep",
            ...
            self.GAME.handle_turn()
            self.assertEqual(
                len(self.player.battlefield), 0
            )  # everything should be bounced
    ...
    def test_indestructible(self):
        with mock.patch(
            ...
            side_effect=[
                ...
                "b 0",
                "",
                "",  # damage shouldn't kill
                "__self.tmp.append(len(self.battlefield == 2))",
                '__self.add_card_to_hand("Ulcerate")',
                "p Ulcerate",
                "b 0",
                "",
                "",  # however, lowering toughness below 0 should
