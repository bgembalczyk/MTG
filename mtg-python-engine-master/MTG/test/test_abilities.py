...
class TestPlayer(TestGameBase):
    ...
    def test_phase_based_conditional_trigger(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                ' and self.battlefield[1].is_color(["W"])',
                "s upkeep",
                "",
                "",
                "s upkeep",
    ...
    def test_activated_ability_targeting(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "a 0_1",
                "p",  # mill myself; the amount should be checked on RESOLUTION
    ...
    def test_board_affecting_static_abilities(self):
        ...
        with mock.patch(
            ...
            self.player.tmp.append(
                [p.power for p in self.player.battlefield] == [4, 2, 4, 4, 4, 4]
            )
    ...
    def test_conditional_self_affecting_static_abilities(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "b 1",
                "",
                "",  # deal 3 dmg to warden, which is currently a 4/4
    ...
    def test_multiple_triggers_ordering_both_players(self):
        ...
        with mock.patch(
            ...
            side_effect=[
                ...
                "0 1",  # order trigger
                "s upkeep",
                "s upkeep",  # let all 3 triggers resolve
            ],
        ):
            self.player.autoOrderTriggers = False
            self.opponent.autoOrderTriggers = False
