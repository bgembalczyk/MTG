        ...
        super(c270446, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.ARTIFACT, cardtype.CardType.CREATURE],
                abilities=[
                    static_abilities.StaticAbilities.First_Strike,
                    static_abilities.StaticAbilities.Flying,
                    static_abilities.StaticAbilities.Lifelink,
                    static_abilities.StaticAbilities.Vigilance,
                ],
            )
        )
        ...
        super(c270447, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                types=[cardtype.CardType.ARTIFACT, cardtype.CardType.CREATURE],
                abilities=[
                    static_abilities.StaticAbilities.Shroud,
                    static_abilities.StaticAbilities.Trample,
                    static_abilities.StaticAbilities.Islandwalk,
                ],
            )
        )
...
class c234736(card.Card):
    ...
    def __init__(self):
        super(c234736, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Fireblast",
                    "text": "You may sacrifice two Mountains rather than pay Fireblast's mana cost.\nFireblast deals 4 damage to target creature or player.",
                    "color": ["R"],
                    "mana_cost": "4RR",
                },
                supertype=[],
...
class c10637(card.Card):
    ...
    def __init__(self):
        super(c10637, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Burning of Xinye",
                    "text": "You destroy four lands you control, then target opponent destroys four lands he or she controls. Then Burning of Xinye deals 4 damage to each creature.",
                    "color": ["R"],
                    "mana_cost": "4RR",
                },
                supertype=[],
        ...
        super(c423507, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                types=[cardtype.CardType.ARTIFACT, cardtype.CardType.CREATURE],
                abilities=[
                    static_abilities.StaticAbilities.Deathtouch,
                    static_abilities.StaticAbilities.Flying,
                ],
            )
        )
        ...
        super(c205393, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Flash],
            )
        )
        ...
        super(c205358, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.ARTIFACT],
                abilities=[],
            )
        )
        ...
        super(c382868, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                abilities=[
                    static_abilities.StaticAbilities.Flying,
                    static_abilities.StaticAbilities.Haste,
                ],
            )
        )
...
class c383056(card.Card):
    ...
    def __init__(self):
        super(c383056, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Psychatog",
                    "text": "Discard a card: Psychatog gets +1/+1 until end of turn.\nExile two cards from your graveyard: Psychatog gets +1/+1 until end of turn.",
                    "color": ["U", "B"],
                    "mana_cost": "1UB",
                    "power": 1,
                    "toughness": 2,
        ...
        super(c383087, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[cardtype.SuperType.LEGENDARY],
                types=[cardtype.CardType.CREATURE],
                abilities=[],
            )
        )
        ...
        super(c370440, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                types=[cardtype.CardType.CREATURE],
                abilities=[
                    static_abilities.StaticAbilities.Flash,
                    static_abilities.StaticAbilities.Flying,
                ],
            )
        )
        ...
        super(c370406, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Trample],
            )
        )
        ...
        super(c370566, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.PLANESWALKER],
                abilities=[],
            )
        )
        ...
        super(c425986, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                types=[cardtype.CardType.PLANESWALKER],
                abilities=[
                    static_abilities.StaticAbilities.Hexproof,
                    static_abilities.StaticAbilities.Trample,
                ],
            )
        )
        ...
        super(c397701, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.TRIBAL, cardtype.CardType.ENCHANTMENT],
                abilities=[],
            )
        )
        ...
        super(c413576, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Defender],
            )
        )
...
class c373322(card.Card):
    ...
    def __init__(self):
        super(c373322, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Tangle Wire",
                    "text": "Fading 4 (This artifact enters the battlefield with four fade counters on it. At the beginning of your upkeep, remove a fade counter from it. If you can't, sacrifice it.)\nAt the beginning of each player's upkeep, that player taps an untapped artifact, creature, or land he or she controls for each fade counter on Tangle Wire.",
                    "color": "",
                    "mana_cost": "3",
                },
                supertype=[],
        ...
        super(c409577, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[cardtype.SuperType.LEGENDARY],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Hexproof],
            )
        )
        ...
        super(c380236, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Deathtouch],
            )
        )
        ...
        super(c373379, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Vigilance],
            )
        )
...
class c382320(card.Card):
    ...
    def __init__(self):
        super(c382320, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Paliano, the High City",
                    "text": "Reveal Paliano, the High City as you draft it. The player to your right chooses a color, you choose another color, then the player to your left chooses a third color.\n{T}: Add one mana to your mana pool of any color chosen as you drafted cards named Paliano, the High City.",
                    "color": "",
                    "mana_cost": "",
                },
                supertype=[cardtype.SuperType.LEGENDARY],
...
class c416784(card.Card):
    ...
    def __init__(self):
        super(c416784, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Arcane Savant",
                    "text": "Before you shuffle your deck to start the game, you may reveal this card from your deck and exile an instant or sorcery card you drafted that isn't in your deck.\nWhen Arcane Savant enters the battlefield, copy a card you exiled with cards named Arcane Savant. You may cast the copy without paying its mana cost.",
                    "color": ["U"],
                    "mana_cost": "3UU",
                    "power": 3,
                    "toughness": 3,
...
class c416798(card.Card):
    ...
    def __init__(self):
        super(c416798, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Custodi Lich",
                    "text": "When Custodi Lich enters the battlefield, you become the monarch.\nWhenever you become the monarch, target player sacrifices a creature.",
                    "color": ["B"],
                    "mana_cost": "3BB",
                    "power": 4,
                    "toughness": 2,
...
class c416819(card.Card):
    ...
    def __init__(self):
        super(c416819, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Caller of the Untamed",
                    "text": "Before you shuffle your deck to start the game, you may reveal this card from your deck and exile a creature card you drafted that isn't in your deck.\n{X}, {T}: Create a token that's a copy of a card you exiled with cards named Caller of the Untamed. X is the converted mana cost of that card.",
                    "color": ["G"],
                    "mana_cost": "3G",
                    "power": 2,
                    "toughness": 4,
...
class c376546(card.Card):
    ...
    def __init__(self):
        super(c376546, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Tempt with Vengeance",
                    "text": "Tempting offer — Create X 1/1 red Elemental creature tokens with haste. Each opponent may create X 1/1 red Elemental creature tokens with haste. For each player who does, create X 1/1 red Elemental creature tokens with haste.",
                    "color": ["R"],
                    "mana_cost": "XR",
                },
                supertype=[],
        ...
        super(c373717, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[cardtype.SuperType.LEGENDARY],
                types=[cardtype.CardType.ENCHANTMENT, cardtype.CardType.ARTIFACT],
                abilities=[],
            )
        )
        ...
        super(c373624, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                types=[cardtype.CardType.CREATURE],
                abilities=[
                    static_abilities.StaticAbilities.Defender,
                    static_abilities.StaticAbilities.Hexproof,
                ],
            )
        )
...
class c409997(card.Card):
    ...
    def __init__(self):
        super(c409997, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Tireless Tracker",
                    "text": 'Whenever a land enters the battlefield under your control, investigate. (Create a colorless Clue artifact token with "{2}, Sacrifice this artifact: Draw a card.")\nWhenever you sacrifice a Clue, put a +1/+1 counter on Tireless Tracker.',
                    "color": ["G"],
                    "mana_cost": "2G",
                    "power": 3,
                    "toughness": 2,
...
class c410032(card.Card):
    ...
    def __init__(self):
        super(c410032, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Tamiyo's Journal",
                    "text": 'At the beginning of your upkeep, investigate. (Create a colorless Clue artifact token with "{2}, Sacrifice this artifact: Draw a card.")\n{T}, Sacrifice three Clues: Search your library for a card and put that card into your hand. Then shuffle your library.',
                    "color": "",
                    "mana_cost": "5",
                },
                supertype=[cardtype.SuperType.LEGENDARY],
        ...
        super(c89064, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.INSTANT],
                abilities=[static_abilities.StaticAbilities.Convoke],
            )
        )
...
class c398428(card.Card):
    ...
    def __init__(self):
        super(c398428, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Kytheon, Hero of Akros",
                    "text": "At end of combat, if Kytheon, Hero of Akros and at least two other creatures attacked this combat, exile Kytheon, then return him to the battlefield transformed under his owner's control.\n{2}{W}: Kytheon gains indestructible until end of turn.",
                    "color": ["W"],
                    "mana_cost": "W",
                    "power": 2,
                    "toughness": 1,
...
class c398520(card.Card):
    ...
    def __init__(self):
        super(c398520, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Sphinx's Tutelage",
                    "text": "Whenever you draw a card, target opponent puts the top two cards of his or her library into his or her graveyard. If they're both nonland cards that share a color, repeat this process.\n{5}{U}: Draw a card, then discard a card.",
                    "color": ["U"],
                    "mana_cost": "2U",
                },
                supertype=[],
        ...
        super(c398495, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Menace],
            )
        )
...
class c398453(card.Card):
    ...
    def __init__(self):
        super(c398453, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Pia and Kiran Nalaar",
                    "text": "When Pia and Kiran Nalaar enters the battlefield, create two 1/1 colorless Thopter artifact creature tokens with flying.\n{2}{R}, Sacrifice an artifact: Pia and Kiran Nalaar deals 2 damage to target creature or player.",
                    "color": ["R"],
                    "mana_cost": "2RR",
                    "power": 2,
                    "toughness": 2,
...
class c407614(card.Card):
    ...
    def __init__(self):
        super(c407614, self).__init__(
            gameobject.Characteristics(
                **{
                    "name": "Chandra, Flamecaller",
                    "text": "+1: Create two 3/1 red Elemental creature tokens with haste. Exile them at the beginning of the next end step.\n0: Discard all the cards in your hand, then draw that many cards plus one.\n−X: Chandra, Flamecaller deals X damage to each creature.",
                    "color": ["R"],
                    "mana_cost": "4RR",
                    "subtype": ["Chandra"],
                },
        ...
        super(c380410, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.ENCHANTMENT, cardtype.CardType.CREATURE],
                abilities=[],
            )
        )
        ...
        super(c430830, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Reach],
            )
        )
        ...
        super(c391927, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Lifelink],
            )
        )
