...
class c26805(card.Card):
    ...
    def __init__(self):
        super(c26805, self).__init__(
            gameobject.Characteristics(
                **{
                    "power": 2,
                    "mana_cost": "2R",
                    "color": ["R"],
                    "text": "{T}: Target land becomes a Plains or an Island until end of turn.",
                    "toughness": 2,
                    "name": "Tundra Kavu",
                    "subtype": ["Kavu"],
                },
...
class c22061(card.Card):
    ...
    def __init__(self):
        super(c22061, self).__init__(
            gameobject.Characteristics(
                **{
                    "text": 'As Overlaid Terrain enters the battlefield, sacrifice all lands you control.\nLands you control have "{T}: Add two mana of any one color to your mana pool."',
                    "mana_cost": "2GG",
...
class c3610(card.Card):
    ...
    def __init__(self):
        super(c3610, self).__init__(
            gameobject.Characteristics(
                **{
                    "power": 1,
                    "mana_cost": "1B",
                    "color": ["B"],
                    "text": "When Brood of Cockroaches is put into your graveyard from the battlefield, at the beginning of the next end step, you lose 1 life and return Brood of Cockroaches to your hand.",
                    "toughness": 1,
        ...
        super(c212614, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.ONGOING, cardtype.CardType.SCHEME],
                abilities=[],
            )
        )
