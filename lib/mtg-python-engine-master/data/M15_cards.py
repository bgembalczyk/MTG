        ...
        super(c383375, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                abilities=[
                    static_abilities.StaticAbilities.Flying,
                    static_abilities.StaticAbilities.Convoke,
                ],
            )
        )
...
class c383395(card.Card):
    ...
    def __init__(self):
        super(c383395, self).__init__(
            gameobject.Characteristics(
                **{
                    "mana_cost": "1W",
                    "text": 'Whenever a nontoken creature enters the battlefield under your control, you may pay {W}. If you do, create a 1/1 white Spirit creature token with flying.\n{1}{W}, Sacrifice a Spirit: Target non-Spirit creature gains indestructible until end of turn. (Damage and effects that say "destroy" don\'t destroy it.)',
                    "name": "Spirit Bonds",
                    "color": ["W"],
                },
                supertype=[],
...
class c383183(card.Card):
    ...
    def __init__(self):
        super(c383183, self).__init__(
            gameobject.Characteristics(
                **{
                    "mana_cost": "3U",
                    "text": "{2}{U}: Target creature can't be blocked this turn.",
                    "subtype": ["Salamander", "Wizard"],
                    "power": 3,
                    "color": ["U"],
        ...
        super(c383175, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.CREATURE],
                abilities=[static_abilities.StaticAbilities.Intimidate],
            )
        )
...
class c383190(card.Card):
    ...
    def __init__(self):
        super(c383190, self).__init__(
            gameobject.Characteristics(
                **{
                    "mana_cost": "2R",
                    "text": "Sliver creatures you control have menace. (They can't be blocked except by two or more creatures.)",
                    "subtype": ["Sliver"],
                    "power": 2,
                    "color": ["R"],
...
class c383198(card.Card):
    ...
    def __init__(self):
        super(c383198, self).__init__(
            gameobject.Characteristics(
                **{
                    "mana_cost": "3R",
                    "text": 'Whenever an Aura becomes attached to Brood Keeper, create a 2/2 red Dragon creature token with flying. It has "{R}: This creature gets +1/+0 until end of turn."',
...
class c383257(card.Card):
    ...
    def __init__(self):
        super(c383257, self).__init__(
            gameobject.Characteristics(
                **{
                    "mana_cost": "1R",
                    "text": 'At the beginning of your upkeep, create a colorless artifact token named Land Mine with "{R}, Sacrifice this artifact: This artifact deals 2 damage to target attacking creature without flying." Then flip a coin. If you lose the flip, Goblin Kaboomist deals 2 damage to itself.',
                    "subtype": ["Goblin", "Warrior"],
                    "power": 1,
                    "color": ["R"],
...
class c383200(card.Card):
    ...
    def __init__(self):
        super(c383200, self).__init__(
            gameobject.Characteristics(
                **{
                    "mana_cost": "4GG",
                    "text": "{5}{G}{G}: Put a +1/+1 counter on Carnivorous Moss-Beast.",
                    "subtype": ["Plant", "Elemental", "Beast"],
                    "power": 4,
                    "color": ["G"],
        ...
        super(c383222, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[],
                types=[cardtype.CardType.ARTIFACT, cardtype.CardType.LAND],
                abilities=[static_abilities.StaticAbilities.Indestructible],
            )
        )
        ...
        super(c383347, self).__init__(
            gameobject.Characteristics(
                **{
                ...
                supertype=[cardtype.SuperType.BASIC],
                types=[cardtype.CardType.LAND],
                abilities=[],
            )
        )
