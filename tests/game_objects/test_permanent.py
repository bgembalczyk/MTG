# test_permanent.py
import pytest
from game_objects.permanent import PermanentMixin, PermanentCard, PermanentSpell, Permanent
...
def test_permanent_card_characteristics(example_name, example_mana_cost, example_rules_text):
    card = PermanentCard(name=example_name, mana_cost=example_mana_cost, rules_text=example_rules_text)
    ...
    assert sorted(example_mana_cost.colors) == characteristics["colors"]
    assert characteristics["rules_text"] == example_rules_text


def test_permanent_spell_characteristics(example_name, example_mana_cost, example_rules_text, player, opponent):
    spell = PermanentSpell(player, opponent, example_name, example_mana_cost, example_rules_text)
...
def test_permanent_status_transitions(example_name, example_mana_cost, example_rules_text, player, opponent):
    permanent = Permanent(player, opponent, example_name, example_mana_cost, example_rules_text)
